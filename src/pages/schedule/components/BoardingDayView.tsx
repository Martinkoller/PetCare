...
function getBoardingStatusMeta(status?: string) {
  switch (status) {
    ...
    case 'confirmed':
      return {
        dot: 'bg-blue-600',
        card: 'bg-blue-100 border-blue-500 text-blue-800',
        label: 'Confirmado',
      }
    case 'checked_in':
    case 'in_progress':
      return {
        dot: 'bg-amber-500',
        card: 'bg-amber-100 border-amber-400 text-amber-800',
        label: 'Em Hospedagem',
      }
    case 'checked_out':
    case 'completed':
      return {
        dot: 'bg-green-600',
        card: 'bg-green-100 border-green-500 text-green-800',
        label: 'Finalizado',
      }
    case 'cancelled':
      return {
        dot: 'bg-red-600',
        card: 'bg-red-100 border-red-500 text-red-800',
        label: 'Cancelado',
      }
    default:
      return {
